...
public class ProductController {
    ...
    public ResponseEntity<Boolean> checkAvailability(@RequestParam String productId, @RequestParam String cep) {
        ...
        String cepCity = addressService.getCityByCep(cep);

        if (cepCity == null) {
            return ResponseEntity.badRequest().body(false);
        }

        boolean isAvailable = productCity != null && productCity.equalsIgnoreCase(cepCity);
